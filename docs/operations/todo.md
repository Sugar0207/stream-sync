...
## 直近でやること
1. hotkey/UI wrapper の最小実装 shape を決める:
   - same-session switcher loop に separate local control channel を追加する最小 transport を決める
   - stdin/scripted parser の command/action names を wrapper transport contract として再利用する
