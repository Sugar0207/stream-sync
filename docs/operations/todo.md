...
## 直近でやること
1. decode/render skip 後の display policy planning を行う（hold previous / black fallback / partial render）
...
## Next Items
1. Plan display policy after scheduler decode/render connection: hold previous frame / black fallback / partial render behavior remain undecided.
2. production H.264 encoder configuration / error logging policy
