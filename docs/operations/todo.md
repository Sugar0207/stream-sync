...
## 直近でやること
1. switcher 側 per-request timeout の上に載せる minimal reconnect/lifecycle policy を planning/docs から整理して最小実装する
2. bounded named-pipe handoff を前提にした server/switcher lifecycle responsibility を manual/runtime 観点で補足整理する
