...
## 直近でやること
1. `2` real slots + `2` deterministic placeholder slots の最小 preview planning を整理する
2. `2` real slots preview でも existing named-pipe handoff wrapper/client と `SwitcherFourViewHandoffValidationBoundary` / clean output family をどう再利用するかを docs に落とす
