...
## 直近でやること
1. switcher named-pipe handoff の no-auto-retry / classification-first lifecycle policy を docs で固定し、その最小実装を追加する
2. lifecycle summary に `attempt_count=1` / final result / last error / retryable classification をどう露出するか整理する
