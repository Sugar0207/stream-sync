...
2. late frame queue mutation / drop policy を最小実装単位に分ける
...
## Next Items
1. production H.264 encoder configuration / error logging policy
2. late frame queue mutation / drop policy
