...
## 直近でやること
1. single-client targetTime source boundary の manual fixture / live-like queue path validation を追加する
...
## Next Items
1. Add manual fixture / live-like validation for the single-client targetTime source boundary.
2. Decide how this single-client targetTime source should feed the existing two-view scheduler without adding late-drop mutation.
