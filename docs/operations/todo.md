...
## 直近でやること
1. real server->switcher handoff を 4-view preview/output family に接続する最小 planning slice を整理する
2. deterministic fixture proof path と real handoff path の責務境界を docs で固定し、4-view preview/read-only first の runtime shape を詰める
