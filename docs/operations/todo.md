...
## 直近でやること
1. single-client targetTime source を既存 2-view scheduler へどう接続するかを整理し、最小 multi-client sync planning を進める
...
## Next Items
1. Decide how the single-client targetTime source should feed the existing two-view scheduler without adding late-drop mutation.
2. Plan the smallest multi-client sync validation path over queued encoded frames.
