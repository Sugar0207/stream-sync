...
## 直近でやること
1. fallible queued-frame handoff を前提に、real server->switcher transport planning を進める
2. production H.264 encoder configuration / error logging policy
3. Decide later whether `--live-two-view-switcher-once` should be renamed or deprecated after the transport-backed server-mediated path exists
