...
- latest throughput diagnostics rerun is `S:\stream-sync\manual-logs\two-client-render-rerun-20260522-075029`. Build from `C:\streamsync-target\stream-sync-rerun\debug\*.exe` is PASS, low-latency args remain active, and the new throughput diagnostics runtime evaluation is VALID
- continuous feed remains PASS in the latest rerun: `continuous_feed_frame_received_count=458`, `continuous_feed_enqueued_count=449`, `continuous_decode_input_from_feeder_count=449`, `continuous_decode_input_from_render_demand_count=5`, and `continuous_decode_feeder_lag_to_selected=2`
- continuous output remains PASS but below source cadence: `continuous_decode_input_frame_count=454`, `continuous_decode_output_frame_count=396`, `continuous_decode_output_throughput_fps=21.773`, `continuous_decode_output_bytes_total=364953600`, and `continuous_decode_output_bytes_per_sec=20065625.687`
- continuous render consumption remains FAIL: `render_used_continuous_decoded_count=0`, `continuous_decode_render_exact_hit_count=0`, `continuous_decode_bounded_lookup_hit_count=0`, `continuous_decode_bounded_lookup_rejected_stale_count=15`, and `continuous_decode_bounded_lookup_rejected_not_ready_count=2`
- latest throughput diagnostics show output cadence pressure directly: `continuous_decode_stdout_expected_frame_bytes=921600`, reader full-frame avg `45.192ms`, reader full-frame max `1217ms`, reader slow count `43`, output frame interval avg `42.228ms`, output frame interval max `382ms`, stdout read throughput `20393.026 bytes/ms`, FFmpeg scale enabled `true`, and FFmpeg output pixel format `bgra`
