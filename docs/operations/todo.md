...
## 直近でやること
1. scheduler-result decode/render adapter を既存 decode/render 境界へつなぐ最小 validation を追加する
...
## Next Items
1. Add a minimal validation or connection slice that runs scheduler adapter output through `SwitcherTwoViewDecodeRenderBoundary`.
2. production H.264 encoder configuration / error logging policy
