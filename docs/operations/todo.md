...
## 直近でやること
1. 4-view manual proof の次 slice として、optional in-process proof with more production-like payloads へ広げるか、real server->switcher handoff/manual preview へ進む前提整理を行う
