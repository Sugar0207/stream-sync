...
## 直近でやること
1. docs/operations/manual-real-encoded-video-poc.md に沿った fragmented real encoded sender -> server reassembly queue path の実機確認
...
## Next Items
1. Run fragmented real encoded sender -> server reassembly queue path manual verification from `docs/operations/manual-real-encoded-video-poc.md`
2. production H.264 encoder configuration / error logging policy
