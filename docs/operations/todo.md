...
## 直近でやること
1. 4-view orchestration の次 slice として、`SwitcherFourViewManualPreviewProofBoundary` の上に thin manual CLI/entry point を最小追加し、既存 compact summary を stdout に出すだけの bounded one-shot proof command を作る
