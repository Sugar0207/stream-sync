...
## 直近でやること
1. switcher 側 per-request timeout を前提にした minimal reconnect/lifecycle policy の最小実装
2. bounded server loop の per-request correlation summary を CLI/manual runtime へどう露出するか決める
