...
## 直近でやること
1. Windows named pipe の one-request / one-response runtime を existing switcher handoff abstraction へ接続する薄い wrapper を追加する
2. one-request / one-response runtime の request-id generation と manual invocation shape を整理する
