...
## 直近でやること
1. 4-view orchestration の次 slice として、`SwitcherFourViewHandoffQuadCompositionRenderConnectionBoundary` の composition-ready decoded slot 結果を受ける fixed `QuadView` actual BGRA composition/render を最小実装で追加する
