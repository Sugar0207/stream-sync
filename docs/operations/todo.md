...
2. existing server bounded handoff service session 1 本・named pipe 1 本・2 distinct real `client_id + run_id` scopes で `2` real slots + `2` placeholders の clean output / OBS downstream 挙動を再手動確認する
