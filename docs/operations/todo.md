...
## Next Items
1. add a switcher-owned in-process manual bridge launcher that runs auth-then-video queue receive and then invokes the placeholder handoff helper on the returned caller-owned queue state
