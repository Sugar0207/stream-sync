...
## 直近でやること
1. dedicated 4-view clean output window boundary を呼ぶ thin manual/runtime entry point を追加する
...
## 将来の polish 候補
- [ ] `--four-view-proof-window-once` に visual confirmation 用の `--hold-ms` / preview hold duration を追加するか後で判断する
...
- [ ] 4-view clean output window を manual/runtime から開ける thin entry point を追加する
- [ ] OBS で映像表示に成功する
- [ ] 720p / 30fps で表示確認する
- [ ] 長時間表示でも安定することを確認する
- [ ] 不要 UI 非表示モードを作る
