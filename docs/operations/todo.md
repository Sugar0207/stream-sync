...
## 直近でやること
1. bounded `max_requests` server accept loop と per-request correlation logging の最小実装
2. switcher 側 per-request timeout を前提にした minimal reconnect/lifecycle policy の最小実装
