...
- 次の中心は heartbeat timeout loop tick の notice queue storage / send wakeup 方針、RTT / offset rejected candidate metrics storage / export 方針、continuous heartbeat loop に進む前の境界整理
...
2. RTT / offset rejected candidate metrics storage / export 方針を整理する
