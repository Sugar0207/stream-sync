...
## 直近でやること
1. named pipe 実装前提の transport-neutral handoff codec / server handler / switcher client adapter を server/switcher runtime へ接続する境界を整理する
2. Windows named pipe の one-request / one-response service-client runtime を最小接続する
