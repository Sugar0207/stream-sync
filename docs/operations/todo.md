...
- 次の中心は heartbeat timeout loop tick の notice queue storage / send wakeup 方針、RTT / offset metrics snapshot の future loop / dashboard 連携方針、continuous heartbeat loop に進む前の境界整理
...
2. RTT / offset metrics snapshot の future loop / dashboard 連携方針を整理する
