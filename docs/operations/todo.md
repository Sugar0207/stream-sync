...
- 残りの主 bottleneck は `render_buffer_scale_loop_elapsed_ms=2115` の scale loop 本体で、`gdi_stretchdibits_elapsed_ms=5` など GDI 系は dominant ではない。Production Readiness は 30fps target 未達のまま FAIL 継続
