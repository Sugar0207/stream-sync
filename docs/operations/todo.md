...
## 直近でやること
1. `--four-view-clean-output-window-loop all-renderable <frames>` の manual actual runtime pass を記録し、その後に OBS Window Capture で `StreamSync 4-view Output` を stable capture target として選択・preview できるかを手動確認する
