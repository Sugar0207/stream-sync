...
## 直近でやること
1. display policy を 2-view composition/render path へつなぐ最小 validation を検討する
...
## Next Items
1. Connect display policy decisions to the existing 2-view composition/render path, or plan 4-view expansion once the 2-view display policy is validated.
2. production H.264 encoder configuration / error logging policy
