...
## 直近でやること
1. docs/operations/manual-real-encoded-video-poc.md に沿って `max_frames=1` or `2` + fragment pacing 付き fragmented real encoded sender -> server reassembly queue path を再実機確認
