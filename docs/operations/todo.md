...
## Next Items
1. distributed-PC validation の手順とログ回収を詰める
2. OBS capture follow-up で switcher の Window Capture 連携を確認する
