...
- 次の中心は heartbeat timeout notice wakeup 実行本体に進む前の境界整理、RTT / offset metrics snapshot の具体的な export cadence / dashboard refresh 方針、completed continuous heartbeat loop 本体の最小実装整理
...
3. completed continuous heartbeat loop 本体の最小実装を整理する
