...
## 直近でやること
1. 4-view orchestration の次 slice として、per-slot decode/render connection か fixed `QuadView` actual composition/render のどちらを先に追加するかを小さく設計し、instruction path を pixel path に接続する
