...
## 直近でやること
1. updated lifecycle summary fields を含む localhost manual rerun を取り、stdout contract を記録する
2. classification-first policy の次に bounded retry wrapper が本当に必要かを判断する
