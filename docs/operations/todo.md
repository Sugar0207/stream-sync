...
## 直近でやること
1. scheduler decode/render connection の次に display policy planning へ進むか、manual live two-view 検証へ進むかを決める
