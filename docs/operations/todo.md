...
## 直近でやること
1. isolated actual OS window proof の最小 command/summary 実装を進める。existing `SwitcherWindowRenderRuntimeHook` を再利用し、deterministic `all-renderable` fixture first・separate command・default tests は backend-free のまま維持する
