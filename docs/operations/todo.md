...
## 直近でやること
1. one-request / one-response named-pipe handoff の manual invocation shape を整理する
2. request-id policy を runtime/manual command へどう露出するか決める
