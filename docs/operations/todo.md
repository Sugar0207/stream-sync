...
## 直近でやること
1. 4-view orchestration の次 slice として、`SwitcherFourViewHandoffValidationBoundary` の上に bounded one-shot manual preview/proof を最小追加し、既存 4-view orchestration output を visible のまま保った thin wrapper として fake runtime first の確認経路を作る
