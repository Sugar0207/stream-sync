...
/// Per-slot instruction produced by adapting fallible 4-view scheduler output
/// for decode/render-facing code.
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction {
    RenderFrame {
        slot_index: usize,
...
/// Slot-preserving output of the fallible 4-view scheduler-result adapter.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewHandoffSchedulerDecodeRenderSlotOutput {
    pub slot: SwitcherFourViewTargetTimeSourceSlotConfig,
    pub instruction: SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction,
}

/// Input for translating fallible 4-view scheduler output into
/// decode/render-facing instructions.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewHandoffSchedulerDecodeRenderAdapterInput {
    pub scheduler_result: SwitcherFourViewTargetTimeHandoffSourceSchedulerResult,
}

/// Adapter output keeps four explicit slot instructions and preserves the
/// aggregate scheduler status without creating fake frames for skipped slots.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewHandoffSchedulerDecodeRenderAdapterOutput {
    pub target_timestamp: TimestampMicros,
    pub scheduler_status: SwitcherFourViewTargetTimeHandoffSourceSchedulerStatus,
    pub slots: [SwitcherFourViewHandoffSchedulerDecodeRenderSlotOutput; 4],
}

/// Previously displayed per-slot state for the first 4-view display policy.
#[derive(Debug, Clone, PartialEq, Eq)]
...
/// Input for the smallest 4-view display policy over explicit adapter output.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewHandoffDisplayPolicyInput {
    pub adapter_output: SwitcherFourViewHandoffSchedulerDecodeRenderAdapterOutput,
    pub previous_slots: [Option<SwitcherFourViewDisplayedSlot>; 4],
    pub current_time: TimestampMicros,
}

/// Per-slot display decision for the first fallible 4-view path.
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SwitcherFourViewHandoffDisplayDecision {
    Update {
        slot_index: usize,
...
/// Output of the smallest 4-view display policy.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewHandoffDisplayPolicyOutput {
    pub scheduler_status: SwitcherFourViewTargetTimeHandoffSourceSchedulerStatus,
    pub target_timestamp: TimestampMicros,
    pub slots: [SwitcherFourViewHandoffDisplayDecision; 4],
}

/// The first fixed 4-view composition mode.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub enum SwitcherFourViewCompositionMode {
    QuadView,
}

/// Fixed 2x2 placement for one `QuadView` slot.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct SwitcherFourViewQuadSlotPlacement {
    pub slot_index: usize,
    pub row: usize,
    pub column: usize,
}

/// Per-slot composition instruction for the first fixed `QuadView` layout.
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SwitcherFourViewQuadCompositionSlotInstruction {
    UseUpdatedFrame {
...
/// Input for fixed `QuadView` composition instruction shaping.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewHandoffQuadCompositionAdapterInput {
    pub display: SwitcherFourViewHandoffDisplayPolicyOutput,
}

/// Output from the smallest fixed `QuadView` composition adapter.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewHandoffQuadCompositionAdapterOutput {
    pub scheduler_status: SwitcherFourViewTargetTimeHandoffSourceSchedulerStatus,
    pub target_timestamp: TimestampMicros,
...
/// Validated render-facing metadata derived from one composed 4-view BGRA
/// canvas.
///
/// This intentionally does not own an additional pixel buffer. Future render
/// consumers should use the composed pixels already preserved in the upstream
/// composition result.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewComposedFrameRenderInput {
    pub width: u32,
    pub height: u32,
    pub pixel_format: SwitcherDecodedFramePixelFormat,
    pub bgra_payload_len: usize,
    pub slots: [SwitcherFourViewQuadComposedSlotMetadata; 4],
}

/// Invalid composed-frame reason for 4-view render-facing adaptation.
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SwitcherFourViewComposedFrameRenderInputError {
    UnsupportedPixelFormat {
        actual: SwitcherDecodedFramePixelFormat,
    },
    InvalidDimensions,
...
impl SwitcherFourViewComposedFrameRenderInput {
    pub fn from_composed_frame(
        frame: &SwitcherFourViewComposedFrame,
    ) -> Result<Self, SwitcherFourViewComposedFrameRenderInputError> {
        if frame.pixel_format != SwitcherDecodedFramePixelFormat::Bgra8 {
            return Err(
                SwitcherFourViewComposedFrameRenderInputError::UnsupportedPixelFormat {
                    actual: frame.pixel_format,
                },
            );
        }
        if frame.width == 0 || frame.height == 0 {
            return Err(SwitcherFourViewComposedFrameRenderInputError::InvalidDimensions);
        }
        ...
        let Some(expected) = frame
            ...
            return Err(
                SwitcherFourViewComposedFrameRenderInputError::InvalidBufferLength {
                    expected: usize::MAX,
        ...
        Ok(Self {
            ...
            bgra_payload_len: frame.pixels.len(),
            slots: frame.slots.clone(),
        })
    }
}

/// Invalid reason for the dedicated 4-view render-facing connection.
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SwitcherFourViewQuadRenderFacingInvalidReason {
    Composition(SwitcherFourViewQuadCompositionInvalidReason),
    RenderInput(SwitcherFourViewComposedFrameRenderInputError),
}

/// Top-level render-facing result after fixed 4-view BGRA composition.
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SwitcherFourViewQuadRenderFacingResult {
    RenderReady {
        input: SwitcherFourViewComposedFrameRenderInput,
    },
    NoRenderableQuadView {
        slots: [SwitcherFourViewQuadComposedSlotMetadata; 4],
    },
    InvalidQuadView {
        reason: SwitcherFourViewQuadRenderFacingInvalidReason,
        slots: [SwitcherFourViewQuadComposedSlotMetadata; 4],
    },
}

/// Output from the dedicated 4-view render-facing connection.
///
/// The upstream composition output remains visible, while the render-facing
/// result adds explicit readiness / no-render / invalid states for future
/// window and OBS consumers.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewQuadRenderFacingConnectionOutput {
    pub scheduler_status: SwitcherFourViewTargetTimeHandoffSourceSchedulerStatus,
    pub composition: SwitcherFourViewQuadCompositionOutput,
...
/// Stable clean-output window title reserved for OBS Window Capture.
pub const SWITCHER_FOUR_VIEW_CLEAN_OUTPUT_WINDOW_TITLE: &str = "StreamSync 4-view Output";

/// Stable identity for the dedicated 4-view clean output window.
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
pub struct SwitcherFourViewCleanOutputWindowIdentity {
    pub title: String,
}

impl Default for SwitcherFourViewCleanOutputWindowIdentity {
    fn default() -> Self {
        Self {
            title: SWITCHER_FOUR_VIEW_CLEAN_OUTPUT_WINDOW_TITLE.to_string(),
        }
    }
}

/// Input for the dedicated 4-view clean output window boundary.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewCleanOutputWindowInput {
    pub render_facing_output: SwitcherFourViewQuadRenderFacingConnectionOutput,
}

/// Result family for the dedicated 4-view clean output window boundary.
#[derive(Debug, Clone, PartialEq, Eq)]
pub enum SwitcherFourViewCleanOutputWindowRenderResult {
    RenderReady {
        width: u32,
        height: u32,
        bgra_payload_len: usize,
...
/// Output from the dedicated 4-view clean output window boundary.
///
/// The render-facing result stays visible, while the output window attempt keeps
/// a stable OBS-friendly window identity separate from proof/diagnostic paths.
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SwitcherFourViewCleanOutputWindowOutput {
    pub scheduler_status: SwitcherFourViewTargetTimeHandoffSourceSchedulerStatus,
    pub window_identity: SwitcherFourViewCleanOutputWindowIdentity,
    pub render_facing: SwitcherFourViewQuadRenderFacingConnectionOutput,
...
/// Minimal adapter from fallible 4-view scheduler results to explicit
/// decode/render-facing instructions.
///
/// This first slice preserves four explicit slots and slot order, keeps
/// handoff/source errors separate from no-frame and waiting states, and does
/// not yet add per-slot display policy or `QuadView` composition.
#[derive(Debug, Clone, Copy, Default, PartialEq, Eq, Hash)]
pub struct SwitcherFourViewHandoffSchedulerDecodeRenderAdapterBoundary;

impl SwitcherFourViewHandoffSchedulerDecodeRenderAdapterBoundary {
    pub fn adapt(
        &self,
        input: SwitcherFourViewHandoffSchedulerDecodeRenderAdapterInput,
    ) -> SwitcherFourViewHandoffSchedulerDecodeRenderAdapterOutput {
        let scheduler_result = input.scheduler_result;
        let slots = scheduler_result.slots.map(|slot_result| {
            let instruction = four_view_handoff_scheduler_decode_render_instruction_for_slot(
                slot_result.slot.slot_index,
                &slot_result.result,
            );
            SwitcherFourViewHandoffSchedulerDecodeRenderSlotOutput {
...
/// Minimal display policy for explicit fallible 4-view adapter output.
///
/// This smallest slice does not decode, render, or compose pixels. It only
/// decides update/hold/no-display/source-error placeholder per slot while
/// preserving source-error detail and slot order.
#[derive(Debug, Clone, Copy, Default, PartialEq, Eq, Hash)]
pub struct SwitcherFourViewHandoffDisplayPolicyBoundary;

impl SwitcherFourViewHandoffDisplayPolicyBoundary {
    pub fn decide(
        &self,
        input: SwitcherFourViewHandoffDisplayPolicyInput,
    ) -> SwitcherFourViewHandoffDisplayPolicyOutput {
        let scheduler_status = input.adapter_output.scheduler_status;
        let target_timestamp = input.adapter_output.target_timestamp;
        let previous_slots = input.previous_slots;
        let current_time = input.current_time;
        let slots = std::array::from_fn(|index| {
            four_view_handoff_display_decision_for_slot(
                input.adapter_output.slots[index].instruction.clone(),
                previous_slots[index].clone(),
                current_time,
            )
        });
...
/// Minimal adapter from 4-view display policy decisions to fixed `QuadView`
/// composition instructions.
///
/// This keeps four explicit slots and 2x2 placement semantics visible without
/// yet composing or rendering an actual quad canvas.
#[derive(Debug, Clone, Copy, Default, PartialEq, Eq, Hash)]
pub struct SwitcherFourViewHandoffQuadCompositionAdapterBoundary;

impl SwitcherFourViewHandoffQuadCompositionAdapterBoundary {
    pub fn adapt(
        &self,
        input: SwitcherFourViewHandoffQuadCompositionAdapterInput,
    ) -> SwitcherFourViewHandoffQuadCompositionAdapterOutput {
        let scheduler_status = input.display.scheduler_status;
        let target_timestamp = input.display.target_timestamp;
        let slots = input
            .display
            .slots
            .map(four_view_quad_composition_instruction_for_decision);
...
fn four_view_handoff_scheduler_decode_render_instruction_for_slot(
    slot_index: usize,
    result: &SwitcherSingleClientTargetTimeHandoffSourceResult,
    ...
    match result {
        ...
        SwitcherSingleClientTargetTimeHandoffSourceResult::NoFrameAvailable {
            ...
            client_queue_len,
            ..
        } => SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::SkipNoFrameAvailable {
            slot_index,
            client_id: client_id.clone(),
            run_id: run_id.clone(),
            target_timestamp: *target_timestamp,
        ...
        SwitcherSingleClientTargetTimeHandoffSourceResult::WaitingForFrameAtOrBeforeTarget {
            ...
            client_queue_len,
            ..
        } => SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::SkipWaitingForFrameAtOrBeforeTarget {
            slot_index,
            client_id: client_id.clone(),
            run_id: run_id.clone(),
            target_timestamp: *target_timestamp,
...
fn four_view_handoff_display_decision_for_slot(
    instruction: SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction,
    previous: Option<SwitcherFourViewDisplayedSlot>,
    current_time: TimestampMicros,
) -> SwitcherFourViewHandoffDisplayDecision {
    match instruction {
        SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::RenderFrame {
            slot_index,
            selected,
        ...
        skipped @ SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::SkipNoFrameAvailable {
            slot_index,
            ..
        }
        | skipped @ SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::SkipWaitingForFrameAtOrBeforeTarget {
            slot_index,
            ..
        } => {
            let Some(frame) = previous else {
                return SwitcherFourViewHandoffDisplayDecision::NoDisplayPlaceholder {
                    slot_index,
                    skipped,
                };
            };
...
fn four_view_quad_composition_instruction_for_decision(
    decision: SwitcherFourViewHandoffDisplayDecision,
) -> SwitcherFourViewQuadCompositionSlotInstruction {
    match decision {
        SwitcherFourViewHandoffDisplayDecision::Update {
            slot_index,
            frame,
            ...
            placement: quad_slot_placement(slot_index),
            frame,
            selected,
            consumed,
        },
...
/// Thin render-facing adapter/connection for a composed 4-view BGRA canvas.
///
/// Composition stays upstream; this boundary validates the composed BGRA frame
/// shape, preserves fixed-slot metadata and scheduler status, and keeps
/// placeholder-only / invalid quad states explicit for future render
/// backends.
#[derive(Debug, Clone, Copy, Default, PartialEq, Eq, Hash)]
pub struct SwitcherFourViewQuadRenderFacingConnectionBoundary;

impl SwitcherFourViewQuadRenderFacingConnectionBoundary {
    pub fn connect_composition_output(
        &self,
        composition: SwitcherFourViewQuadCompositionOutput,
    ) -> SwitcherFourViewQuadRenderFacingConnectionOutput {
        let scheduler_status = composition.scheduler_status;
        let render = match &composition.composition {
            SwitcherFourViewQuadCompositionResult::ComposedFrame { frame } => {
                match SwitcherFourViewComposedFrameRenderInput::from_composed_frame(frame) {
                    Ok(input) => SwitcherFourViewQuadRenderFacingResult::RenderReady { input },
                    Err(error) => SwitcherFourViewQuadRenderFacingResult::InvalidQuadView {
                        reason: SwitcherFourViewQuadRenderFacingInvalidReason::RenderInput(error),
                        slots: frame.slots.clone(),
                    },
                }
            }
            SwitcherFourViewQuadCompositionResult::NoRenderableQuadView { slots } => {
                SwitcherFourViewQuadRenderFacingResult::NoRenderableQuadView {
                    slots: slots.clone(),
                }
            }
            SwitcherFourViewQuadCompositionResult::InvalidQuadView { reason, slots } => {
                SwitcherFourViewQuadRenderFacingResult::InvalidQuadView {
                    reason: SwitcherFourViewQuadRenderFacingInvalidReason::Composition(
                        reason.clone(),
                    ),
                    slots: slots.clone(),
                }
...
/// Dedicated 4-view clean output window boundary for future OBS Window Capture.
///
/// This keeps the proof window path separate and consumes the same render-facing
/// family as other downstream window/output consumers.
#[derive(Debug, Clone, Copy, Default, PartialEq, Eq, Hash)]
pub struct SwitcherFourViewCleanOutputWindowBoundary;

impl SwitcherFourViewCleanOutputWindowBoundary {
    pub fn render_with_runtime(
        &self,
        input: SwitcherFourViewCleanOutputWindowInput,
        runtime: &impl SwitcherWindowRenderRuntimeHook,
    ) -> SwitcherFourViewCleanOutputWindowOutput {
        let window_identity = SwitcherFourViewCleanOutputWindowIdentity::default();
        let output = SwitcherFourViewComposedCanvasWindowRenderBoundary::default()
            .render_with_runtime(
                SwitcherFourViewComposedCanvasWindowRenderInput {
                    render_facing_output: input.render_facing_output,
                    window_title: window_identity.title.clone(),
                    render_hold_millis: 0,
                },
                runtime,
            );
        let output_window = match output.window_render {
            SwitcherFourViewComposedCanvasWindowRenderConnectionRenderResult::RenderReady {
                width,
                height,
                bgra_payload_len,
            ...
            SwitcherFourViewComposedCanvasWindowRenderConnectionRenderResult::InvalidQuadView {
                reason,
                slots,
            } => SwitcherFourViewCleanOutputWindowRenderResult::InvalidQuadView { reason, slots },
        };

        SwitcherFourViewCleanOutputWindowOutput {
            scheduler_status: output.scheduler_status,
            window_identity,
            render_facing: output.render_facing,
            output_window,
        }
    }
}
...
mod tests {
    ...
    fn fallible_four_view_adapter_output(
        ...
        SwitcherFourViewHandoffSchedulerDecodeRenderAdapterBoundary
            .adapt(SwitcherFourViewHandoffSchedulerDecodeRenderAdapterInput { scheduler_result })
    }

    fn four_view_display_policy_output_for_test(
        adapter_output: SwitcherFourViewHandoffSchedulerDecodeRenderAdapterOutput,
        previous_slots: [Option<SwitcherFourViewDisplayedSlot>; 4],
        current_time: TimestampMicros,
    ) -> SwitcherFourViewHandoffDisplayPolicyOutput {
        SwitcherFourViewHandoffDisplayPolicyBoundary.decide(
            SwitcherFourViewHandoffDisplayPolicyInput {
                adapter_output,
                previous_slots,
                current_time,
            },
    ...
    fn four_view_quad_composition_adapter_output_for_test(
        display: SwitcherFourViewHandoffDisplayPolicyOutput,
    ) -> SwitcherFourViewHandoffQuadCompositionAdapterOutput {
    ...
    fn four_view_quad_render_facing_output_for_test(
        composition: SwitcherFourViewQuadCompositionOutput,
    ) -> SwitcherFourViewQuadRenderFacingConnectionOutput {
        SwitcherFourViewQuadRenderFacingConnectionBoundary::default()
    ...
    fn four_view_clean_output_window_output_for_test(
        render_facing_output: SwitcherFourViewQuadRenderFacingConnectionOutput,
        render: &impl SwitcherWindowRenderRuntimeHook,
    ) -> SwitcherFourViewCleanOutputWindowOutput {
        SwitcherFourViewCleanOutputWindowBoundary::default().render_with_runtime(
    ...
    #[test]
    fn four_view_handoff_scheduler_decode_render_adapter_maps_all_selected_to_render_frames() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
        ...
        let output = fallible_four_view_adapter_output(scheduler_result);

        assert_eq!(
            output.scheduler_status,
            SwitcherFourViewTargetTimeHandoffSourceSchedulerStatus::AllSelected
        );
        for (expected_index, slot) in output.slots.iter().enumerate() {
            assert_eq!(slot.slot.slot_index, expected_index);
            assert!(matches!(
                slot.instruction,
                SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::RenderFrame {
                    slot_index,
    ...
    #[test]
    fn four_view_handoff_scheduler_decode_render_adapter_preserves_selected_and_no_frame() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
        ...
        assert!(matches!(
            output.slots[0].instruction,
            SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::RenderFrame { .. }
        ));
        assert_eq!(
            output.slots[3].instruction,
            SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::SkipNoFrameAvailable {
                slot_index: 3,
    ...
    #[test]
    fn four_view_handoff_scheduler_decode_render_adapter_preserves_selected_and_waiting() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
        ...
        assert_eq!(
            ...
            SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::SkipWaitingForFrameAtOrBeforeTarget {
                ...
                candidate_capture_timestamp: TimestampMicros(1_000_005),
                client_queue_len: 1,
            }
        );
    }
    ...
    #[test]
    fn four_view_handoff_scheduler_decode_render_adapter_preserves_selected_and_source_error() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
    ...
    #[test]
    fn four_view_handoff_scheduler_decode_render_adapter_preserves_slot_order_and_metadata() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_with_run_payload(
            &mut state,
            "client-0",
        ...
        let scheduler_result = {
            ...
            SwitcherFourViewTargetTimeHandoffSourceSchedulerBoundary::default()
                .select_quad_preview_from_handoff(
                    &mut handoff,
                    fallible_four_view_scheduler_input(TimestampMicros(1_000_024)),
                )
        };

        let output = fallible_four_view_adapter_output(scheduler_result);

        assert_eq!(output.slots[0].slot.slot_index, 0);
        assert_eq!(output.slots[1].slot.slot_index, 1);
        assert_eq!(output.slots[2].slot.slot_index, 2);
        assert_eq!(output.slots[3].slot.slot_index, 3);
        let SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::RenderFrame {
            slot_index,
            selected,
            consumed,
        } = &output.slots[0].instruction
        else {
            panic!("slot 0 should preserve renderable metadata");
        };
        assert_eq!(*slot_index, 0);
        assert!(!consumed);
        assert_eq!(selected.frame.client_id, ClientId("client-0".to_string()));
        assert_eq!(selected.frame.run_id, RunId("run-0".to_string()));
        assert_eq!(selected.frame.frame_id, 21);
        assert_eq!(selected.frame.width, 640);
        assert_eq!(selected.frame.height, 360);
        assert_eq!(selected.frame.encoded_payload_len, 3);
        assert_eq!(selected.frame.encoded_payload, vec![0x0a, 0x0b, 0x0c]);
    }

    #[test]
    fn four_view_handoff_display_policy_updates_all_renderable_slots() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
        ...
        store_frame_for_run(
            ...
            "run-3",
            4,
            TimestampMicros(2_103_700),
        );
        let adapter_output = fallible_four_view_adapter_output({
            let mut handoff = SwitcherInProcessQueuedFrameHandoff::new(&mut state);
            SwitcherFourViewTargetTimeHandoffSourceSchedulerBoundary::default()
                .select_quad_preview_from_handoff(
                    &mut handoff,
        ...
        let output = four_view_display_policy_output_for_test(
            adapter_output,
            [None, None, None, None],
        ...
        for (expected_index, slot) in output.slots.iter().enumerate() {
            assert!(matches!(
                slot,
                SwitcherFourViewHandoffDisplayDecision::Update { slot_index, .. }
                if *slot_index == expected_index
            ));
        }
    }
    ...
    #[test]
    fn four_view_handoff_display_policy_holds_previous_for_no_frame() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
        ...
        let SwitcherFourViewHandoffDisplayDecision::HoldPrevious {
            slot_index,
            skipped,
            hold_duration_micros,
            ..
            ...
            panic!("no-frame with previous should hold previous");
        };
        assert_eq!(*slot_index, 3);
        assert_eq!(*hold_duration_micros, 100);
        assert!(matches!(
            skipped,
            SwitcherFourViewHandoffSchedulerDecodeRenderSlotInstruction::SkipNoFrameAvailable { .. }
        ));
    ...
    #[test]
    fn four_view_handoff_display_policy_uses_placeholder_for_no_frame_without_previous() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
    ...
    #[test]
    fn four_view_handoff_display_policy_holds_previous_for_waiting() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
    ...
    #[test]
    fn four_view_handoff_display_policy_uses_source_error_placeholder_without_previous() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
    ...
    #[test]
    fn four_view_quad_composition_adapter_keeps_slots_in_order_and_preserves_placeholders() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_for_run(
            &mut state,
            "client-0",
        ...
        store_frame_for_run(
            ...
            "run-2",
            3,
            TimestampMicros(2_105_600),
        );
        let display = four_view_display_policy_output_for_test(
        ...
        let output = four_view_quad_composition_adapter_output_for_test(display);

        assert_eq!(
            output.scheduler_status,
            SwitcherFourViewTargetTimeHandoffSourceSchedulerStatus::HandoffError
        );
        assert_eq!(output.mode, SwitcherFourViewCompositionMode::QuadView);
        for (expected_index, slot) in output.slots.iter().enumerate() {
    ...
    #[test]
    fn four_view_quad_render_facing_connection_returns_render_ready_and_preserves_metadata() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_with_run_payload(
            &mut state,
            "client-0",
        ...
        store_frame_with_run_payload(
            ...
            "run-1",
            2,
            TimestampMicros(2_108_700),
            2,
            1,
            vec![20],
        );

        let output = four_view_quad_render_facing_output_for_test(
        ...
        let SwitcherFourViewQuadCompositionResult::ComposedFrame { frame } =
            ...
            panic!("mixed renderable and placeholder quad should still compose");
        };
        let SwitcherFourViewQuadRenderFacingResult::RenderReady { input } = &output.render else {
            panic!("composed quad view should be render-ready");
        };

        assert_eq!(input.width, frame.width);
        assert_eq!(input.height, frame.height);
        assert_eq!(input.pixel_format, frame.pixel_format);
        assert_eq!(input.bgra_payload_len, frame.pixels.len());
        assert_eq!(input.slots, frame.slots);
        assert!(matches!(
            input.slots[2].kind,
            SwitcherFourViewQuadComposedSlotKind::NoDisplayPlaceholder { .. }
        ));
    ...
    #[test]
    fn four_view_quad_render_facing_connection_preserves_no_renderable_quad_view() {
        let mut state = ServerVideoFrameQueueState::default();
                        ...
                        four_view_display_policy_output_for_test(
                            fallible_four_view_adapter_output({
                                ...
                                SwitcherFourViewTargetTimeHandoffSourceSchedulerBoundary::default()
                                    .select_quad_preview_from_handoff(
                                        &mut handoff,
                                        fallible_four_view_scheduler_input(TimestampMicros(
                                            1_000_004,
                                        )),
                                    )
                            }),
        ...
        let SwitcherFourViewQuadRenderFacingResult::NoRenderableQuadView { slots } = &output.render
        else {
            panic!("placeholder-only quad should stay an explicit no-render state");
        };
    ...
    #[test]
    fn four_view_quad_render_facing_connection_preserves_invalid_quad_view() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_with_run_payload(
            &mut state,
            "client-0",
        ...
        let SwitcherFourViewQuadRenderFacingResult::InvalidQuadView { reason, slots } =
            &output.render
        else {
            panic!("invalid composition should remain explicit in render-facing output");
        };
        assert!(matches!(
            reason,
    ...
    #[test]
    fn four_view_clean_output_window_boundary_uses_stable_obs_friendly_title_and_preserves_metadata(
    ) {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_with_run_payload(
            &mut state,
        ...
        let runtime = RecordingTwoViewRender::default();
        let output = four_view_clean_output_window_output_for_test(
            four_view_quad_render_facing_output_for_test(
                four_view_quad_composition_output_for_test(
                    four_view_quad_composition_render_connection_output_for_test(
                        four_view_quad_composition_adapter_output_for_test(
                                    ...
                                    .select_quad_preview_from_handoff(
                                        ...
                                        SwitcherFourViewTargetTimeHandoffSourceSchedulerInput {
                                            slots: [
                                                four_view_slot(0, "client-0", "run-0"),
                                                four_view_slot(1, "client-1", "run-1"),
                                                four_view_slot(2, "client-2", "run-missing"),
                                                four_view_slot(3, "", "run-3"),
                                            ],
                                            target_timestamp: TimestampMicros(1_000_004),
                                        },
        ...
        assert_eq!(requests[0].hold_millis, 0);
        let SwitcherFourViewCleanOutputWindowRenderResult::RenderReady {
            width,
            height,
            bgra_payload_len,
            slots,
            ...
            panic!("clean output window should render one composed quad view");
        };
        assert_eq!(*width, 4);
        assert_eq!(*height, 2);
        assert_eq!(*bgra_payload_len, 32);
        ...
        assert_eq!(source_error_count, 1);
        let SwitcherFourViewComposedCanvasRenderResult::Rendered { render } = render else {
            panic!("clean output render result should stay explicit");
        };
        assert_eq!(render.width, 4);
        assert_eq!(render.height, 2);
        assert_eq!(render.title, SWITCHER_FOUR_VIEW_CLEAN_OUTPUT_WINDOW_TITLE);
        assert_eq!(render.hold_millis, 0);
    }

    #[test]
    fn four_view_clean_output_window_boundary_keeps_placeholder_only_explicit_without_runtime() {
        let mut state = ServerVideoFrameQueueState::default();
        ...
        let SwitcherFourViewCleanOutputWindowRenderResult::NoRenderableQuadView { slots } =
            &output.output_window
        else {
            panic!("placeholder-only clean output should not call the runtime");
        };
        for slot in slots {
            assert!(matches!(
                slot.kind,
    ...
    #[test]
    fn four_view_clean_output_window_boundary_keeps_invalid_quad_explicit_without_runtime() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_with_run_payload(
            &mut state,
            "client-0",
        ...
        let SwitcherFourViewCleanOutputWindowRenderResult::InvalidQuadView { reason, slots } =
            &output.output_window
        else {
            panic!("invalid clean output should stay explicit without runtime");
        };
        assert!(matches!(
            reason,
            SwitcherFourViewComposedCanvasWindowRenderInvalidReason::Upstream(
    ...
    #[test]
    fn four_view_clean_output_window_boundary_keeps_proof_window_path_title_unchanged() {
        let mut state = ServerVideoFrameQueueState::default();
        store_frame_with_run_payload(
            &mut state,
            "client-0",
        ...
        let proof_runtime = RecordingTwoViewRender::default();
        let proof_output = four_view_window_render_output_for_test(
            four_view_quad_render_facing_output_for_test(
                four_view_quad_composition_output_for_test(
                    four_view_quad_composition_render_connection_output_for_test(
                        four_view_quad_composition_adapter_output_for_test(
        ...
        let proof_requests = proof_runtime.requests.borrow();
        assert_eq!(proof_requests.len(), 1);
        assert_eq!(proof_requests[0].title, "StreamSync 4-view");
        assert_ne!(
            proof_requests[0].title,
            SWITCHER_FOUR_VIEW_CLEAN_OUTPUT_WINDOW_TITLE
        );
        assert!(matches!(
            proof_output.window_render,
            SwitcherFourViewComposedCanvasWindowRenderConnectionRenderResult::RenderReady { .. }
        ));
    }
    ...
    fn previous_four_view_displayed_slot(
        slot_index: usize,
        displayed_at: TimestampMicros,
